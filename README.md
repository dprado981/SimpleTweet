...
* [x] Highlights hashtags and mentions in body of tweet
  * [x] Mentions lead to profile when clicked
  * [x] Hashtags don't do anything when clicked
* [x] Retweet and favorite counts are shown next to symbol
* [x] Prohibits user from submitting Tweet if over character limit 

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/dprado981/SimpleTweet/blob/master/SimpleTweetWalkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

It was difficult to get the offline tweets to work properly all of the time, but I got it to work for the majority of cases.
